...
def create_state_researcher(state_name: str, domain: str, approach: str) -> AgentConfig:
    ...
    return AgentConfig(
        ...
        mandate=(
            ...
            f"Learn from your destroyed claims.\n\n"
            f"When submitting a Discovery claim, you MUST include all of these sections in this exact order:\n"
            f"- CLAIM TYPE: Discovery\n"
            f"- POSITION: [your claim]\n"
            f"- STEP 1 through STEP N: [reasoning chain]\n"
            f"- CONCLUSION: [summary]\n"
            f"- GAP ADDRESSED: [what new ground this covers]\n"
            f"- CITATIONS: [#IDs or None]\n"
            f"- KEYWORDS: [3-5 terms]\n\n"
            f"Include a brief OPERATIONAL DEF line after your POSITION. "
            f"This can be informal for philosophical domains. Examples:\n"
            f"- OPERATIONAL DEF: 'consciousness' = reportable unified experience + global availability for reasoning/behavior\n"
            f"- OPERATIONAL DEF: 'causation' = the minimal explanatory relation a model uses to support intervention and counterfactual prediction\n\n"
            f"Keep it to one line. This is a scope-setter, not a full theory.\n\n"
            f"If you reference any specific number, measurement, or quantity in your reasoning steps, include an inline label:\n"
            ...
            f"Example: 'the specious present spans approximately 2-3 seconds (EVIDENCE CLASS: established_literature)'\n\n"
            f"When submitting a Foundation claim:\n"
            f"- CLAIM TYPE: Foundation\n"
            f"- POSITION: [your claim]\n"
            f"- STEP 1 through STEP N: [reasoning chain]\n"
            f"- CONCLUSION: [summary]\n"
            f"- CITATIONS: [at least one #ID from main archive]\n"
            f"- KEYWORDS: [3-5 terms]\n\n"
            f"When submitting a Challenge claim:\n"
            f"- CLAIM TYPE: Challenge\n"
            f"- POSITION: [your challenge]\n"
            f"- CHALLENGE TARGET: [#ID of claim being challenged]\n"
            f"- STEP 1 through STEP N: [attack reasoning]\n"
            f"- CONCLUSION: [summary]\n"
            f"- KEYWORDS: [3-5 terms]\n\n"
            f"Now produce exactly one claim."
        ),
