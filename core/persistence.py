...
class PersistenceLayer:
    ...
    def _create_tables(self, conn: sqlite3.Connection):
        conn.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS archive_entries (
                ...
                secondary_rejection_reason TEXT DEFAULT '',
    ...
    def _ensure_archive_entries_columns(self, conn: sqlite3.Connection):
        ...
        if "validation_json" not in cols:
            conn.execute("ALTER TABLE archive_entries ADD COLUMN validation_json TEXT DEFAULT NULL")
        conn.execute(
        ...
        with self._get_conn() as conn:
            conn.execute("""
                INSERT INTO archive_entries (
                    ...
                    outcome, ruling_type, rejection_reason, secondary_rejection_reason, outcome_reasoning, open_questions_json,
            ...
            """, {
                ...
                "secondary_rejection_reason": d.get("secondary_rejection_reason", ""),
    ...
    def get_principle_count(self, domain: str) -> int:
        ...
        # Principles are generated by the abstraction system agent and therefore
        # do not carry a rival State as source_state. Count principles that
        # compress claims from this domain by looking at their citations.
        with self._get_conn() as conn:
            principle_rows = conn.execute(
                "SELECT citations_json FROM archive_entries WHERE entry_type = 'principle'"
            ).fetchall()
